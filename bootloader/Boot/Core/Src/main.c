...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define APP_START_ADDR  0x70000000   // application flash start
#define BOOT_OK_BYTE    0xA5
#define BOOT_FAIL_BYTE  0x5A
...
int verify_firmware(void)
{
    ...
    // 2. Compare to hdr->hash

    return 1; // TEMP: always valid
}
